          ...
          <div className="top">
            <div className="logIn">
              <div className="log">
                ...
                <p>With the Integrated Windows Authentication (IWA) you can use your Windows authentication
                                to do an automatic login.</p>
              </div>
            ...
            <div className="helpWapper">
              <div className="help">
                <h3>Help</h3>
                <hr />
                <b>NEW: Integrated Windows Authentication</b>
